...
echo "     launchctl load $LAUNCHD_DIR/com.cemal.x.shorts.plist"
echo "     # Sonra uyku ayarını kapat (06:30 + 07:00 cron tetiklensin):"
...
echo "  $FACTORY_DIR/scripts/shorts_factory.sh"
