...
echo ""
echo "  2. PRIMARY cihaz ise launchd'i yükle:"
...
echo "     launchctl load $LAUNCHD_DIR/com.cemal.x.vera.plist    # VERA günlük brief (08:00)"
echo "     launchctl load $LAUNCHD_DIR/com.cemal.x.veraweekly.plist  # VERA haftalık review (Pazar 21:30)"
echo "     # Sonra uyku ayarını kapat (07:00 cron tetiklensin):"
echo "     # sudo pmset -c sleep 0"
echo "     # sudo pmset repeat wakeorpoweron MTWRFSU 06:55:00"
echo ""
echo "  3. SECONDARY cihaz ise launchd YÜKLEME — sadece manuel komut çalıştır."
echo "     PRIMARY iCloud'a yazıyor, SECONDARY iCloud'dan okuyor."
echo ""
echo "Test komutu:"
